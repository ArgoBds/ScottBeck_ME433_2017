...
void APP_Initialize(void) {
    ...
    OC1RS = 600; // max allowed value is 1119
    OC1R = 0; // read-only initial value
    OC4RS = 600; // max allowed value is 1119
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_READ:
            ...
            if (appData.readBuffer[0] == 'r') {
                ...
                if (readBufferOld == '1') {
                    ...
                    else if(LATAbits.LATA1 == 0){
                        LATAbits.LATA1 = 1;
                    }
                } else if (readBufferOld == '2') {
                    LATBINV = 0x0008;
                } else if (readBufferOld == '3') {
                    if (OC1RS < 999) {
                        OC1RS += 200;
                    } else {
                        OC1RS = 1199;
                    }
                } else if (readBufferOld == '4') {
                    if (OC1RS > 200) {
                        OC1RS -= 200;
                    } else {
                        OC1RS = 0;
                    }
                } else if (readBufferOld == '5') {
                    if (OC4RS < 999) {
                        OC4RS += 200;
                    } else {
                        OC4RS = 1199;
                    }
                } else if (readBufferOld == '6') {
                    if (OC4RS > 200) {
                        OC4RS -= 200;
                    } else {
                        OC4RS = 0;
            ...
            readBufferOld = appData.readBuffer[0];
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            if (appData.isReadComplete) {
                len = sprintf(dataOut, "%c %c", appData.readBuffer[0],readBufferOld);
